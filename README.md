...
6. Создание зарезервированных ячеек - функция `add_io_variables`
7. Установка стартового адреса программы (с учетом смещения относительно данных и зарезервированных ячеек) - функция `add_start_address`
